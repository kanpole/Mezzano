...
(defun dump-thread-state (thread)
  (cond ((mezzano.supervisor:thread-full-save-p thread)
         ...
         (let ((registers #+x86-64 '(("r15" . mezzano.supervisor:thread-state-r15)
                                     ("r14" . mezzano.supervisor:thread-state-r14)
                                     ("r13" . mezzano.supervisor:thread-state-r13)
                                     ("r12" . mezzano.supervisor:thread-state-r12)
                                     ("r11" . mezzano.supervisor:thread-state-r11)
                                     ("r10" . mezzano.supervisor:thread-state-r10)
                                     (" r9" . mezzano.supervisor:thread-state-r9)
                                     (" r8" . mezzano.supervisor:thread-state-r8)
                                     ("rdi" . mezzano.supervisor:thread-state-rdi)
                                     ("rsi" . mezzano.supervisor:thread-state-rsi)
                                     ("rbx" . mezzano.supervisor:thread-state-rbx)
                                     ("rdx" . mezzano.supervisor:thread-state-rdx)
                                     ("rcx" . mezzano.supervisor:thread-state-rcx)
                                     ("rax" . mezzano.supervisor:thread-state-rax)
                                     ("rbp" . mezzano.supervisor:thread-state-rbp)
                                     ("rip" . mezzano.supervisor:thread-state-rip)
                                     (" cs" . mezzano.supervisor:thread-state-cs)
                                     ("rflags" . mezzano.supervisor:thread-state-rflags)
                                     ("rsp" . mezzano.supervisor:thread-state-rsp)
                                     (" ss" . mezzano.supervisor:thread-state-ss))
                          #+arm64 '((" x0" . mezzano.supervisor:thread-state-r8)
                                    (" x1" . mezzano.supervisor:thread-state-r9)
                                    (" x2" . mezzano.supervisor:thread-state-r10)
                                    (" x3" . mezzano.supervisor:thread-state-r11)
                                    (" x4" . mezzano.supervisor:thread-state-r12)
                                    (" x5" . mezzano.supervisor:thread-state-rcx)
                                    (" x6" . mezzano.supervisor:thread-state-rbx)
                                    (" x7" . mezzano.supervisor:thread-state-r13)
                                    (" x9" . mezzano.supervisor:thread-state-rax)
                                    ("x10" . mezzano.supervisor:thread-state-rdx)
                                    ("x11" . mezzano.supervisor:thread-state-rsi)
                                    ("x12" . mezzano.supervisor:thread-state-rdi)
                                    ("x13" . mezzano.supervisor:thread-state-r14)
                                    ("x14" . mezzano.supervisor:thread-state-r15)
                                    ("x29" . mezzano.supervisor:thread-state-rbp)
                                    ("x30" . mezzano.supervisor:thread-state-cs)
                                    (" pc" . mezzano.supervisor:thread-state-rip)
                                    (" sp" . mezzano.supervisor:thread-state-rsp)
                                    ("cpsr" . mezzano.supervisor:thread-state-rflags)
                                    ("fpsr/fpcr" . mezzano.supervisor:thread-state-ss))))
           (loop for (name . reader) in registers
                 do (format t " ~A: ~8,'0X~%" name (funcall reader thread))))
         #+arm64
         (flet ((read-xmm (index)
